      ...
      <div className="space-y-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex gap-3 animate-pulse">
            <div className="w-5 h-5 rounded-full bg-slate-200 shrink-0 mt-1" />
    ...
    <div className="space-y-8">
      ...
      {hasVersions && (
        <div>
          ...
          <div className="relative space-y-4 before:absolute before:inset-0 before:ml-2.25 before:-translate-x-px before:h-full before:w-0.5 before:bg-linear-to-b before:from-slate-200 before:via-slate-200 before:to-transparent">
            {versions.map((v: any) => {
                  ...
                  <div className="flex-1 min-w-0 pb-1">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <a
                        ...
                        className="shrink-0 p-1.5 rounded-lg bg-slate-50 hover:bg-indigo-50 text-slate-400 hover:text-indigo-500 transition-colors border border-slate-100"
                        title="Download file"
                      >
                        <FileText size={11} />
                      </a>
          ...
          <div className="relative space-y-4 before:absolute before:inset-0 before:ml-2.25 before:-translate-x-px before:h-full before:w-0.5 before:bg-linear-to-b before:from-slate-200 before:via-slate-200 before:to-transparent">
            {reviews.map((rev: any) => (
              <div key={rev.id} className="relative flex items-start gap-3">
                <div className="shrink-0 w-5 h-5 rounded-full border-2 border-slate-200 bg-white flex items-center justify-center z-10 mt-0.5">
                  <div
