...
const ProjectManagement = () => {
  ...
  const allTasks = reviews?.flatMap((r: any) => r.tasks) || [];
  ...
  return (
    <div className="flex h-full w-full bg-[#F8FAFC]  text-slate-900 selection:bg-indigo-100">
      ...
      <aside
        className={`
        fixed inset-y-0 left-0 z-70 w-72 bg-white border-r border-slate-200 transform transition-transform duration-300 ease-in-out
